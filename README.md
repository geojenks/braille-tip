...
## Build walkthrough
An interactive build & hand-off guide (BraillePen, with the Coil-Tac liquid-metal mechanism) is
published via GitHub Pages: **https://geojenks.github.io/braille-tip/** — source in [`docs/`](docs/).
